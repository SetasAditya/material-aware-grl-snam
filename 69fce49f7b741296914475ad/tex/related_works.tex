...
A final related thread studies adaptation over multiple timescales, in which
...
Our three loops have a similar motivation, combining fast local correction,
episodic tail-risk updates, and slower curriculum advancement. The state being
adapted is nonetheless explicitly structured, since local corrections and
...
Prior work therefore covers each ingredient in isolation, spanning structured
...
closed loop, through a material-energy enrichment that reshapes the Hamiltonian
